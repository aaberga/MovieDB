//
//  MovieDB_MoviesNowPlaying_API.swift
//  MovieDB
//
...
private let kAPIURLString = "https://api.themoviedb.org/3/movie/now_playing"
...
class MovieDB_MoviesNowPlaying_API {
    
    static func sendRequest(withCompletion completionBlock: @escaping (_ result: Any?, _ error: Error?) -> Void) {
        ...
        /* Create the Request:
         Get Movies Now Playing (GET https://api.themoviedb.org/3/movie/now_playing)
         */
